...
namespace MaNGOS
{
    ...
    */
    ...
    {
        public:
            AnySpellAssistableUnitInObjectRangeCheck(WorldObject const* obj, SpellEntry const* spellInfo, float range)
    ...
    {
        public:
            AnyFriendlyUnitInObjectRangeCheck(WorldObject const* obj, float range)
